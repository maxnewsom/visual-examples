...
def main():
    ...
    driver.get("https://www.carelonrx.com")

    element3 = driver.find_elements(By.CLASS_NAME, 'content__heading ')

    driver.execute_script("arguments[0].innerText = 'putting the back into pharmacy';", element3)
